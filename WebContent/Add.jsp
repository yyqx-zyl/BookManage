        ...
        <form method="post" class="form-inline" role="form" action="Add"  >
        	<table >
        		...
        		<tr>
        			...
        			<td>
        				<div class="form-group">
        					<input type="text" class="form-control" id="author" name="publish" >
        				</div>
        			</td>
        		</tr>
        		<tr>
        			...
        			<td>
        				<div class="form-group">
        					<input type="date" class="form-control" id="author" name="publishdate" >
        				</div>
        			</td>
        		</tr>
        		<tr>
        			...
        			<td>
        				<div class="form-group">
        					<input type="text" class="form-control" id="author" name="Page" >
        				</div>
        			</td>
        		</tr>
        		<tr>
        			...
        			<td>
        				<div class="form-group">
        					<input type="text" class="form-control" id="author" name="Price" >
        				</div>
        			</td>
        		</tr>
        		<tr>
